 ...
 * =====================================================================================
 *
 *       Filename:  svmsg_file_server.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  10/16/2014 04:14:16 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
main(int argc, char *argv[])
{
	...
	/* Establish SIGCHLD handler to reap terminated childres */
	...
	/* If msgrcv() of fork() fails, remove server MQ and exit */
