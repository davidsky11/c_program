 ...
 * =====================================================================================
 *
 *       Filename:  mprotect_t.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  10/09/2014 03:29:55 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int main(int argc, char *argv[]) {
	...
	/* Create an anoymous maooing with all access denied */
	addr = mmap(NULL, LEN, PROT_NONE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
	if (addr == MAP_FAILED)
	  errExit("mmap");

	/* Diaplay line from /proc/self/maps corresponding to mapping */
